      ...
      <section className={`py-24 transition-colors duration-300 ${isDark ? 'bg-[#141414]' : 'bg-gray-50'}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Expert Therapists', description: 'Our certified therapists bring years of experience in traditional and modern techniques.', icon: '✨', image: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?w=400&q=80' },
              { title: 'Natural Products', description: 'We use only organic, locally-sourced products for all our treatments.', icon: '🌿', image: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?w=400&q=80' },
              { title: 'Serene Environment', description: 'Immerse yourself in our peaceful spa designed for ultimate relaxation.', icon: '🕯️', image: 'https://images.unsplash.com/photo-1540555700478-4be289fbec6d?w=400&q=80' },
            ].map((feature, index) => (
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            <InView animation="fade-up">
              <h2 className={`section-title mb-4`}>
                Treatment <span className="text-emerald-600 dark:text-emerald-400">Menu</span>
              </h2>
            </InView>
            <InView animation="fade-up" delay={100}>
            ...
            <div key={category} className="mb-12 last:mb-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {SPA_TREATMENTS.filter(t => t.category === category).map((treatment, index) => (
                  <InView key={treatment.name} animation="fade-up" delay={index * 50}>
                    <div className={`rounded-xl p-5 flex items-center justify-between transition-all duration-300 ${
                      ...
                      <span className="text-emerald-600 dark:text-emerald-400 font-semibold">{treatment.price}</span>
                    </div>
                  </InView>
                ))}
              </div>
